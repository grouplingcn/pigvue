  ...
  >
    ...
    <div class="banner ">
      <div>
        ...
        <p class="sub-slogan">多平台房源爬虫 + 高德地图强力驱动 + 最新数据实时推送 , 帮助你迅速找到合适房源。</p>
    ...
    <div class="contact " ref="contact">
      <div>
        ...
        <div class="ways">
          <div>
            <span>邮件: </span><em>groupling@qq.com</em>
          </div>
        </div>
        <!-- <div class="ewm">
          <img src="./../images/ewm1.jpg"/>
          <span>( 欢迎关注【安得广夏千万屋】微信公众号获取租房技巧/体验小猪租搜房小程序/房源精选. )</span>
        </div> -->
      </div>
    </div>
    <footer>
      <div>
        <div>
          Copyright 2016 - 2021 www.pigdata.top. All Rights Reserved
