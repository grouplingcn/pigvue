<template>
  ...
  >
    <div>
      ...
      <a href="https://wj.qq.com/s/2953926/aabe" target="_blank" class="title"  v-else>小猪租搜房</a>
      <nav v-if="!isMobile">
        <ul>
          <li>
          ...
          <li>
              <a href="http://www.groupling.net" target="_blank" class="nav-item">关于我们</a>
          </li>
        </ul>
      </nav>
    </div>
    ...
    >
      <div class="history-notices">
        <el-collapse accordion>
          <el-collapse-item :name="item.uid" v-for="item in historyNotices"
                            :key="item.uid">
              <template slot="title">
